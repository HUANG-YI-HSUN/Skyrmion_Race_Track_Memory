...
double TreeClassification::computePredictionAccuracyInternal(std::vector<double>* prediction_error_casewise) {
  cout << "In TreeClassification::computePredictionAccuracyInternal." << endl ;
  ...
  for (size_t i = 0; i < num_predictions; ++i) {
    ...
    cout << "In TreeClassification, predicted_value: " << predicted_value << endl ;
    double real_value = data->get_y(oob_sampleIDs[i], 0);
    cout << "In TreeClassification, real_value: " << predicted_value << endl ;
